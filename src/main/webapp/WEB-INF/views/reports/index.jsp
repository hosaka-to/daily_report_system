            ...
            <tbody>
                ...
                <c:forEach var="report" items="${reports}" varStatus="status">
                    ...
                    <tr class="row${status.count % 2}">
                        <td class="report_startTime"><fmt:formatDate value="${reportstartTime}" pattern="HH:mm" /></td>
                        <td class="report_finishTime"><fmt:formatDate value="${reportfinishTime}" pattern="HH:mm" /></td>
